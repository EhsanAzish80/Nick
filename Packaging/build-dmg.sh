...
PKG_PATH=${PKG_PATH:-"/Users/Shared/Nick-4.0.1-build-405.pkg"}
OUTPUT_PATH=${OUTPUT_PATH:-"/Users/Shared/Nick-4.0.1-build-405.dmg"}
WORK_DIR=${WORK_DIR:-"${TMPDIR%/}/NickDMG405"}
