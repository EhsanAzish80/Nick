...
The current stable release is **Nick 4.4 (build 422)** for macOS 26 and later.
...
Version 4.4 release notes are in
[Packaging/Release/v4.4.0/RELEASE_NOTES.md](Packaging/Release/v4.4.0/RELEASE_NOTES.md).
...
Nick 4.4 is the current production release. Every future release remains gated
